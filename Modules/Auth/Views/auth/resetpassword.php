				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
					...
					<div class="d-flex flex-column-fluid flex-center">
						...
						<div class="login-form">
                			...
                			<?php endif; ?> 
							<form class="form" id="reset_password" method="post" action="<?= base_url('resetpassword') ?>">
								...
								<!--begin::Form group-->
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" type="password" placeholder="Confirm password" id="cpassword" name="cpassword" autocomplete="off" />
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<!-- <div class="form-group">
...
if(flag==1)
{
	...
	toastr.error("Token is expired", "Error");
}	

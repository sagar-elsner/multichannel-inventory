				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
					...
					<div class="d-flex flex-column-fluid flex-center">
						...
						<div class="login-form">
                			...
                			<?php endif; ?>
							<form class="form" id="forgot_password" action="<?= base_url('forgotpassword')?>" method="post">
								<!--begin::Title-->
								...
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" type="email" placeholder="Email" name="email_address" autocomplete="off" />
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group d-flex flex-wrap pb-lg-0">
									...
									<button type="button" onclick="window.location='<?=route_to('/')?>'"  class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3">Cancel</button>
								</div>
								<!--end::Form group-->
							</form>
							<!--end::Form-->
		...
		<script type="text/javascript">
			...
			if(flag==1)
			{
				toastr.options = {
					...
					toastr.error("Please enter correct email address", "Invalid Email");
			}	

							...
							<form class="form" id="login_form" method="post" action="<?= base_url('/login') ?>">
								...
								<div class="form-group">
									<div class="d-flex justify-content-between mt-n5">
										...
										<a href="<?=base_url('/forgot_password')?>" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5" >Forgot Password ?</a>
									</div>
...
toastr.error("These credentials do not match our records", "Login Failed");
}	

...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Mutlichannel Inventory</title>
				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
					...
					<div class="d-flex flex-column-fluid flex-center">
						...
						<div class="login-form ">
							...
							<form class="form" id="login_form" method="post" action="<?= base_url('login') ?>">
								<!--begin::Title-->
								...
								<div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="text" name="email_address" id="email_address" autocomplete="off" />
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group">
									<div class="d-flex justify-content-between mt-n5">
										...
										<a href="<?=route_to('forgot_password')?>" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5" >Forgot Password ?</a>
									</div>
					...
					<div class="d-flex justify-content-lg-start justify-content-center align-items-end py-7 py-lg-0">
						<div class="text-dark-50 font-size-lg font-weight-bolder mr-10">
							...
							<a href="#" target="_blank" class="text-dark-75 text-hover-primary">Multichannel Inventory</a>
						</div>
			...
			$('#login_form').validate({
				...
				messages:
				{
					...
					password:
					{
						...
						passwordStrength:'Password must contain atleast one digit one special character'
